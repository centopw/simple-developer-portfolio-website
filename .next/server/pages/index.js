...
function Home({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(ContainerBlock/* default */.Z, {
    title: "Cento - Think different, Be unique",
    description: "A developer, Designer, and a programer!",
    children: [/*#__PURE__*/jsx_runtime_.jsx(Hero, {}), /*#__PURE__*/jsx_runtime_.jsx(LatestCode, {
...
const getServerSideProps = async () => {
  ...
  const repositories = await lib_getLatestRepos(data/* default */.Z, token); // console.log("REPOSITORIES", repositories);
